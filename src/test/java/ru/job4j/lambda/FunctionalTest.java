...
public class FunctionalTest {
    ...
    public void whenLinearFunctionThenLinearResults() {
        List<Double> result = Functional.diapason(5, 8, x -> 2 * x + 1);
    ...
    public void whenLinearFunctionThenQuadraticResults() {
        List<Double> result = Functional.diapason(5, 8, x -> 2 * x * x + 1);
    ...
    public void whenLinearFunctionThenIndicativeResults() {
        List<Double> result = Functional.diapason(5, 8, x -> 2 * Math.pow(x, x) + 1);
